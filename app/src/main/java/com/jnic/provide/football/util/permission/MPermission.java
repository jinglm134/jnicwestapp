package com.jnic.provide.football.util.permission;//package com.jnic.provide.football.util.permission;
...
import com.jnic.provide.football.util.permission.annotation.OnMPermissionDenied;
import com.jnic.provide.football.util.permission.annotation.OnMPermissionGranted;
import com.jnic.provide.football.util.permission.annotation.OnMPermissionNeverAskAgain;
...
import static com.jnic.provide.football.util.permission.MPermissionUtil.getActivity;

public class MPermission {
    private String[] permissions;
    private int requestCode;
    private Object object; // DemoActivity or fragment
